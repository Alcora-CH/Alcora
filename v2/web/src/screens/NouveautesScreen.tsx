    ...
    <div className="absolute inset-0 z-50 grid place-items-center"
      ...
      <div className="ilot flex max-h-[78vh] w-[min(560px,92vw)] flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-2.5 border-b border-line px-4 py-3">
          ...
          <button onClick={onFermer} aria-label={t('commun.fermerEchap')} title={t('commun.fermerEchap')}
        ...
        <div className="border-t border-line px-4 py-3">
          <button onClick={onFermer}
                  className="w-full rounded-lg py-2 text-[13px] font-semibold transition-opacity hover:opacity-90"
